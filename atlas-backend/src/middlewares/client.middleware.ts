 ...
 * @description Middleware de contrôle d'accès pour les routes réservées aux clients.
 * Doit être chaîné après `authMiddleware` qui injecte `req.user`.
 * Empêche les vendeurs d'accéder aux fonctionnalités panier/commandes.
 */
import type { Request, Response, NextFunction } from "express";

/**
 * Vérifie que l'utilisateur connecté possède le rôle "CLIENT".
 * Bloque les vendeurs et les utilisateurs non authentifiés avec les codes HTTP appropriés.
